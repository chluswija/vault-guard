      ...
      >
        <div className="glass-strong rounded-2xl p-8 shadow-lg">
          ...
          <div className="text-center mb-8">
            <div className="w-14 h-14 mx-auto rounded-xl gradient-primary flex items-center justify-center mb-4 shadow-glow">
            ...
            <p className="text-muted-foreground mt-1">
              {mode === 'signin'
                ? 'Sign in to access your secure data'
                : 'Start managing your digital life securely'}
            </p>
          </div>
        ...
        <p className="text-center text-xs text-muted-foreground mt-4 px-4">
          ...
          We never see your passwords or sensitive information.
        </p>
      </motion.div>
    </div>
  );
